...
void RenderScene::upload_gpu_data( UploadGpuDataContext& context ) {
    ...
    for ( u32 bin = 0; bin < k_light_z_bins; ++bin ) {
        ...
        for ( u32 i = 0; i < k_num_lights; ++i ) {
            ...
            // compute the minimum and maximum point of the light sphere from the camera’s point of view
    ...
    // transform the light position in camera space
    for ( u32 i = 0; i < k_num_lights; ++i ) {
        ...
        // If the light is behind the camera, don’t do any further processing.
        ...
        if ( context.use_view_aabb ) {
            ...
            // compute the corners of the AABB projected to clip space
        ...
        // determine the size of the quad in screen space
        ...
        // set the bit for the light we are processing on all the tiles it covers
        ...
        // If the light is not visible on the screen, move to the next light
