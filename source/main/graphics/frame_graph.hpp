...
struct FrameGraphResource {
    ...
    FrameGraphNodeHandle                    producer; // Stores a reference to the node that outputs a resource.
    FrameGraphResourceHandle                output_handle; // Stores the parent resource.

    i32                                     ref_count = 0; // be used when computing which resources can be aliased
